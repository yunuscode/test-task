...
export default function ListItem({
  ...
  return (
    <li
      className={`flex items-center border-2 rounded-xl lg:w-2/3 sm:w-4/5 w-[90%] p-2 px-3 h-[80px] relative lg:mr-0 lg:ml-0 ${marginTop} ${borderColor} ${zIndex} ${
        position.left ? "md:ml-auto md:mr-4" : "md:mr-auto md:ml-4"
      }`}
    >
      ...
      <Checkbox
        name="integration_switch"
        id={id}
        changeCategory={checkboxAction}
        checked={isItemActive}
        className="ml-auto xl:mr-3 mr-1"
      />
    </li>
  );
}
